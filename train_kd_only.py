...
def parse_args():
    ...
    parser.add_argument("--kd-temperature", type=float, default=5.0, help="logits KD temperature")
    parser.add_argument("--lambda-kd", type=float, default=0.9, help="lambda_kd")
