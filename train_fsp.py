    ...
    def train(self):
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            if iteration % log_per_iters == 0 and save_to_disk:
                logger.info(
                    "Iters: {:d}/{:d} || Lr: {:.6f} || Task Loss: {:.4f} || FSP Loss: {:.4f}" \
...
def save_checkpoint(model, args, is_best=False):
    ...
    filename = 'fsp_{}_{}_{}.pth'.format(args.student_model, args.student_backbone, args.dataset)
    ...
    if is_best:
        best_filename = 'fsp_{}_{}_{}_best_model.pth'.format(args.student_model, args.student_backbone, args.dataset)
